                                                        ...
                                                        <div class="row ">
                                                            ...
                                                            <div class="col-xl-6">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <input type="text" class="form-control"
                                                                               id="bornIN" name="bornIN"
                                                                               value="{{(isset($contact)?$contact->bornIN : (old('bornIN') ? old('bornIN') : ''))}}"
                                                            ...
                                                            <div class="col-xl-6">
                                                                <div class="form-group row">
                                                                    <label class="col-lg-4 col-form-label" for="other">فعالیت
                                                                        های دیگر
                                                                    </label>
                                                                    <div class="col-lg-6">
