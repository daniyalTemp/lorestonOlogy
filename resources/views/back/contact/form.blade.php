                                                                    ...
                                                                    <li>
                                                                        ...
                                                                        <a class="timeline-panel text-muted"
                                                                           href="{{route('dashboard.contact.editEducation' , $education->id)}}">
                                                                            <div class="card text-white bg-dark-alt">
                                                        ...
                                                        <ul class="timeline">
                                                            ...
                                                            <li>
                                                                <div class="timeline-panel">
                                                                    ...
                                                                    <div class="media-body">
                                                                        <h5 class="mb-1">گزارش با موفقیت ایجاد شد <span
                                                            ...
                                                            <li>
                                                                <div class="timeline-panel">
                                                                    ...
                                                                    <div class="media-body">
                                                                        <h5 class="mb-1">دکتر جعفر برای شما عکس ارسال می
                                                                            کند <span class="badge light badge-danger">خطر </span>
                                                                        </h5>
                                                                        <small class="d-block">آبان 1399 - 13:45 بعد
                                                                            ظهر</small>
                                                                    </div>
                                                                    ...
                                                                    <li>
                                                                        <div class="timeline-panel">
                                                                            ...
                                                                            <div class="media-body">
                                                                                ...
                                                                                <br>
                                                                                <small class="d-block">
                                                                                    <a  data-toggle="modal" data-target="#detach{{$paper->id}}"
                                                                        ...
                                                                        <!-- Modal -->
                                                                        <div class="modal fade" id="detach{{$paper->id}}">
                                                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                                                <div class="modal-content">
                                                                                    <div class="modal-header">
                                                                                        <h5 class="modal-title"> حذف کاربر از مقاله</h5>
                                                                                    ...
                                                                                    <div class="modal-footer">
                                                                                        ...
                                                                                        <a   href="{{route('dashboard.paper.detach' ,[ $paper->id , $contact->id])}}" class="btn btn-danger">حذف</a>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <li>
                                                                        <div class="timeline-panel">
                                                                            ...
                                                                            <div class="media-body">
                                                                                ...
                                                                                <h5 class="mb-1">{{$book->title}} <small
                                                                                        class="text-muted"> {{$book->year}}</small></h5>
                                                                                </a>
                                                                                <p class="mb-1">{{$book->publication}}</p>
                                                                                <a  data-toggle="modal" data-target="#detachBook{{$book->id}}"
                                                                                    class="btn btn-outline-danger  btn-block btn-xxs">حذف</a>

                                                                            </div>
                                                                        </div>
                                                                        <!-- Modal -->
                                                                        <div class="modal fade" id="detachBook{{$book->id}}">
                                                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                                                <div class="modal-content">
                                                                                    <div class="modal-header">
                                                                                        <h5 class="modal-title"> حذف کاربر از کتاب</h5>
                                                                                        <button type="button" class="close" data-dismiss="modal"><span>&times;</span>
                                                                                        </button>
                                                                                    </div>
                                                                                    <div class="modal-body">
                                                                                    ...
                                                                                    <div class="modal-footer">
                                                                                        <button type="button" class="btn btn-dark light" data-dismiss="modal">بستن</button>
                                                                                        <a   href="{{route('dashboard.book.detach' ,[ $book->id , $contact->id])}}" class="btn btn-danger">حذف</a>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                        ...
                                                        <ul class="timeline">
                                                            <li>
                                                                <div class="timeline-panel">
                                                                    ...
                                                                    <div class="media-body">
                                                                        <h5 class="mb-0">سند مکاتبه شهر</h5>
                                                                        <small class="text-muted">آبان 1399 - 13:45 بعد
                                                                            ظهر</small>
                                                                    </div>
                                                                </div>
                                                            </li>
