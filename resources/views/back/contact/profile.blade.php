                    ...
                    <div class="profile-info">
                        <div class="profile-photo">
                            <img src="{{asset('storage/images/contacts/'.$contact->image)}}"
                                 class="img-fluid rounded-circle" alt="{{$contact->Name}}">
                        </div>
                        <div class="profile-details">
                            <div class="profile-name px-3 pt-3">
                                <h4 class="text-primary mb-0">{{$contact->Name}}</h4>
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-xxl-6 col-sm-12">
                                            <div class="card text-white bg-gray-dark ">
                                                <ul class="list-group list-group-flush ">
                                                    <li class="list-group-item d-flex justify-content-between"><span class="mb-0">نام :</span><strong>{{$contact->Name}}</strong></li>
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-xxl-6 col-sm-12">
                                            <div class="card text-white bg-gray-dark ">
                                                <ul class="list-group list-group-flush ">
                                                    ...
                                                    <li class="list-group-item d-flex justify-content-between"><span class="mb-0">محل تولد :</span><strong>{{$contact->bornIN}}</strong></li>
